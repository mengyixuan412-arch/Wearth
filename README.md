...
![我的衣橱](docs/screenshots/wardrobe.jpg)

卡片下面那行 `¥141/次 · 已穿 7 次` 就是 CPW。它不是标价 ——
是这件衣服到今天为止，真实的每一次穿着花了多少钱。

![衣橱统计](docs/screenshots/analysis.jpg)

统计页把购买与养护分开记。右侧「衣橱投入」里养护占 8.7%，
这个比例正是 CPW 的分子必须带上养护支出的理由。
